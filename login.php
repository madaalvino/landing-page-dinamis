...
<html lang="en" data-bs-theme="auto">
	<head>
		...
		<title>Halaman Login &mdash; Mada Project</title>
	...
	<body class="d-flex align-items-center py-4 bg-body-tertiary">
		...
		<?php
				...
				?>       
				<img class="mb-4" src="assets/img/<?= $data['logo'];?>" alt="" width="100" >
					...
					if(isset($_GET['pesan'])) {
						if($_GET['pesan'] === 'belum_login'){
							...
							<div class="alert alert-danger" role="alert">
								<strong>Gagal</strong> Silakan login dulu...
							</div>
							<?php
						}else if($_GET['pesan'] === 'gagal'){
							?>
							<div class="alert alert-danger" role="alert">
								<strong>Gagal</strong> Username/Password tidak ditemukan...
							</div>
							<?php
						}else if($_GET['pesan'] === 'logout'){
							?>
							<div class="alert alert-success" role="alert">
								<strong>Berhasil</strong> Anda berhasil keluar dari halaman admin...
							</div>
							<?php
						}
					}
			...
			<div class="text-body-secondary text-center my-3">
