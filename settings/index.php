	...
	<body>
		...
		<main class="container">
			<div class="mt-4 p-5 bg-primary text-white rounded">
				...
				<p>Selamat datang <strong><?= $_SESSION['username'] ?></strong> Anda dapat mengubah pengaturan landing page disini... </p>
			</div>
				...
				<table class="table">
					...
					<tbody>
						<tr>
							...
							<td><?= $d['button_name'];?></td>
							<td>
								<img src="../assets/img/<?= $d['logo'];?>" class="img-fluid" width="100px" alt="">
							</td>
							<td>
